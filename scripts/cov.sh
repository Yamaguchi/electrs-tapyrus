...
grcov ./target/debug/deps -s . -t lcov --llvm --branch --ignore-not-existing --ignore "/*" -o report/lcov.info
genhtml -o report/ --show-details --highlight --ignore-errors source --legend report/lcov.info
